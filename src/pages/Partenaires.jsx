...
const Partenaires = () => {
  const partenaires = [
    ...
    },
    {
      ...
      descr:
        "Je suis enchantée de vous accueillir dans ma petite bulle artistique. Moi c'est Cindy, infographiste metteur en page ici vous découvrirez toutes mes réalisations, que ce soit celles des clients ou des créations personnelles qui sont disponibles à la vente.",
