  ...
  return (
    <div className="font-quicksand max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-1">
      ...
      <h2 className="font-quicksand text-2xl md:text-6xl xl:text-7xl font-bold tracking-tight mb-6 text-pinkDark">
        ...
        <p className="text-xl md:text-xl xl:text-xl tracking-tight mb-12">
          Chez Wendev, j'ai à coeur de travailler avec des personnes de
          confiance, avec des compétences variées et ayant à coeur d'offrir le meilleur à leurs clients du monde littéraire. Voici la crème de
        ...
        <section className="lg:grid grid-cols-2 gap-4">
          {partenaires.map((partenaire) => (
            ...
            >
              ...
              <p className="p-6 font-bold tracking-tight">{partenaire.offer}</p>
              <button
