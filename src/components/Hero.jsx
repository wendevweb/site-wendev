            ...
            <Fade triggerOnce cascade="true" direction="left" duration={1000}>
              <div className="mt-32 z-10 font-quicksand ">
                ...
                <p className="font-quicksand text-xl text-white opacity-70">
                  ...
                  neuf à un site existant ? D'une page d'authentification ?
                  D'un portfolio personnel ou professionnel ? D'une maquette pour le web
                  ? Tu es auteur.e et tu souhaites avoir ton site internet comme
                  un pro ? <br />
                  <br />
