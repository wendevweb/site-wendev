...
const Partenaires = () => {
  ...
  return (
    <div className="lg:m-10 p-10">
      ...
      <div className="pt-10 lg:grid grid-cols-3 gap-2">
          ...
          <div key={partner.id} className="flip-card ml-6 mr-6 font-quicksand">
            <div className="flip-card-inner ">
              ...
              <div className="flip-card-back font-quicksand">
                ...
                <h3>{partner.name}</h3>
                <p>{partner.service}</p>
                <button className="border border-white font-bold rounded-md shadow-lg mt-2 p-2 hover:bg-real hover:border-real hover:text-pinkDark">
                  <a
